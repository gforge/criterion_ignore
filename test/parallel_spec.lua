...
function criterion_ignore_test.Parallel()
   ...
   local pc = criterion_ignore.Parallel.new()
   ...
   local pc1 = criterion_ignore.Parallel.new(true):add(mse1, 0.5):add(mse1:clone())
   ...
   local pc2_1 = criterion_ignore.Parallel.new():add(nll2_1, 0.5):add(mse2)
   local pc2_2 = criterion_ignore.Parallel.new():add(nll2_2, 0.4):add(pc2_1)
   ...
   local pc3 = criterion_ignore.Parallel.new():add(nll3_1, 0.5):add(nll3_2, 1, 0)
